...
#define ACTUATOR_TYPE "heating_system"

/* Log configuration */
#include "sys/log.h"
#define LOG_MODULE "heating-system"
#define LOG_LEVEL LOG_LEVEL_APP

#define INTERVAL_BETWEEN_SIMULATIONS 3
#define INTERVAL_BETWEEN_CONNECTION_TESTS 1

extern coap_resource_t res_heating_sys_switch;
...
PROCESS_THREAD(heating_sys_server, ev, data)
{
  PROCESS_BEGIN();
  ...
  LOG_INFO("Starting Heating System CoAP-Server\n");
  coap_activate_resource(&res_heating_sys_switch, "heating-system/switch"); 
